<template>
  <div>
    <ModuleTitle :moduleTitle="config.moduleTitle" />
    <SubModuleBlockTitle :blockTitle="config.blockTitle" />
    <div v-for="(area, idx) in moduleConfig.infoAreaList" :key="idx">
...
export default defineComponent({
  // 启用了类型推导
  props: {
    moduleConfig: { type: Object, default:():ModuleConfig=>({})},
  },
  data() {
    return {
      config: { 
